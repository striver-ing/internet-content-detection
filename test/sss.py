...
if __name__ == '__main__':
    url_info = {'remark': '', '_id': '5975b4ed53446557e04bdc45', 'url': 'http://weixin.sogou.com/weixin?query=环球军事&_sug_type_=&s_from=input&_sug_=y&type=1&page=1&ie=utf8', 'depth': 0, 'status': 0, 'site_id': 1}
