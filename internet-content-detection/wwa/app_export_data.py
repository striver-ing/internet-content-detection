...
def main():
    ...
    export_data.export_to_oracle(source_table = 'WWA_app_content_info', aim_table = 'TAB_MVMS_APP_CONTENT', key_map = key_map, unique_key = 'ORIGINAL_URL', condition = {'read_status':0, "image_pron_status" : 2})
    ...
    key_map = {
        ...
        'CONTENT_ID': 'int_content_id',                  # 目标键 = 值                   类型为int
        'RELEASE_TIME': 'date_release_time',
    ...
    export_data.export_to_oracle(source_table = 'WWA_app_vioation_content_info', aim_table = 'TAB_MVMS_VIOLATION_CONTENT', key_map = key_map, unique_key = 'ORIGINAL_URL', condition = {'read_status':0, "image_pron_status" : 2})
