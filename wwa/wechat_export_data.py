...
def account_main():
    ...
    export_data.export_to_oracle(source_table = 'WWA_wechat_official_accounts', aim_table = 'TAB_MVMS_WECHAT_INFO', key_map = key_map, unique_key = 'ACCOUNT_ID', update_read_status = False, unique_key_mapping_source_key = unique_key_mapping_source_key, condition = {'read_status':0, "image_pron_status" : 2})
...
def article_main():
    ...
    export_data.export_to_oracle(source_table = 'WWA_wechat_article', aim_table = 'TAB_MVMS_WECHAT_ARTICLE_INFO', key_map = key_map, unique_key = 'ARTICLE_TITLE', condition = {'read_status':0, "image_pron_status" : 2})
