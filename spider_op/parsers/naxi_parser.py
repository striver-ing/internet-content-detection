...
if __name__ == '__main__':
    # url = "http://www.naxi.gov.cn/lycontent.jsp?id=4028813e513850860151387816250048"
    ...
    #                watched_count       = %s
    #                content             = %s
    #             ''' % (1 + 1, url, title, release_time, origin, watched_count, content))
    # urls = tools.get_urls(html)
    # print(urls)
    # for url in urls:
    #     for url in urls:
    ...
    url_indo = {
            "_id" : "58f72f2aea18a9314015d1be",
            "url" : "http://www.naxi.gov.cn/content.jsp?id=4028818c5b3bb8c9015b848561021362&classid=606c3df196bb432288b48dd9dee59c84",
            "depth" : 0,
            "site_id" : 4,
            "remark" : "",
            "status" : 2
